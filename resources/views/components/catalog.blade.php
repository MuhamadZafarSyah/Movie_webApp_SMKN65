        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="row row--grid">
                    @if ($movies->isEmpty())
                        <div
                            style="width: 100%;margin-top: 40px; display: flex; justify-content: center; align-items: center">
                            <h1 style="color: white">Movie Yang Anda Cari Tidak Ada</h1>
                        </div>
                </div>
            @else
                @foreach ($movies->take(18) as $item)
