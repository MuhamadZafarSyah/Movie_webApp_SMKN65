        ...
        <form action="{{ route('movie.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid gap-4 grid-cols-1 lg:grid-cols-2 sm:gap-6">
                <div class="col-span-2 lg:col-span-1">
                    ...
                    <input id="input" type="text" name="judul" id="judul" value="{{ old('judul') }}"
                ...
                <div class="w-full col-span-2 lg:col-span-1">
                    ...
                    <input id="input" type="text" name="genre" id="genre" value="{{ old('genre') }}"
                ...
                <div class="w-full col-span-2 lg:col-span-1">
                    <label id="darkmode" for="link_movie"
                        ...
                        Movie(Youtube)</label>
                    <input id="input" type="text" name="link_movie" id="link_movie" value="{{ old('link_movie') }}"
                ...
                <div class="col-span-2 lg:col-span-1">
                    ...
                    <input type="text" name="actor" id="actor" value="{{ old('actor') }}"
                        ...
                        placeholder="Masukan Nama Nama Actor">
                    @error('actor')
                        <div class=" text-xs text-red-500">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-span-2 lg:col-span-1">
                    ...
                    <input type="text" name="sutradara" id="sutradara" value="{{ old('sutradara') }}"
                ...
                <div class="col-span-2">
                    ...
                    <textarea class="form-control deskripsi darkmode darkmodebg" id="input" id="deskripsi"
                        placeholder="Enter the Description" name="deskripsi"></textarea>
                </div>
            </div>
            <button type="submit"
